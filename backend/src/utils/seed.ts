...
async function main() {
  ...
  const course = await prisma.course.upsert({
    ...
    create: {
      ...
      description:
        'Aprende los fundamentos del desarrollo web moderno con HTML, CSS y JavaScript. Este curso te llevará desde cero hasta crear tus primeras páginas web interactivas.',
